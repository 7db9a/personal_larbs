...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/7db9a/personal_voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/7db9a/personal_LARBS/master/progs.csv"
